...
public class Notification extends BaseSchema {
    ...
    public static String createTitle(Type type) {
    ...
    public static String createBody(Type type, NotificationDetail notificationDetail) {
        ...
        return switch (type) {
            ...
            case MEETING_SUCCESS -> {
                MeetingSuccessDetail detail = (MeetingSuccessDetail) notificationDetail;
                yield String.format("%s의 모임이 종료되었습니다.", detail.getMeeting().getTitle());
            }
            case MEETING_REVIEW -> {
                MeetingReviewDetail detail = (MeetingReviewDetail) notificationDetail;
                yield String.format(
                        "%s의 %s님이 리뷰를 달았습니다.",
                        detail.getMeeting().getTitle(),
